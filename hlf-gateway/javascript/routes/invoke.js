 ...
 *     parameters:
 *       - name: secret
 *         description: secret key of your jwt token
 *         in: formData
 *         required: true
 *     responses:
 *       200:
 *         description: jwt token create Successfully!
 *       404:
 *         description: Invalid credentials
 *       500:
 *         description: Internal Server Error
 */
 router.post ('/jwtToken',api.jwtToken);
 ...
 *         required: false
 *       - name: Document_Link
 *         description: Asset Document link
 *         in: formData
 *         required: false
 *       - name: token
 *         description: jwt token
 ...
 *         required: false
 *       - name: Document_Link
 *         description: Partnership Document link
 *         in: formData
 *         required: false
 *       - name: token
 *         description: jwt token
 ...
 */
 ...
 //  *         required: true
 //  *       - name: lpName
//  *         description: Limited Partner Name
//  *         in: formData
//  *         required: false
//  *       - name: lpEmail
//  *         description: Limited Partner Email
...
//  *         required: false
//  *       - name: lpAmount
//  *         description: Limited Partner Amount
//  *         in: formData
//  *         required: true
//  *       - name: assetId
//  *         description: Asset ID
...
// *         in: formData
// *         required: false
// *       - name: assetHoldingDate
// *         description: Asset Holding Date
// *         in: formData
// *         required: false
// *       - name: documentId
// *         description: Asset Document ID
